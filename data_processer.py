...
def build_template_internlm2(query, answer = None,prefix=None, history=None):
    prompt = prefix or "You are an AI assistant whose name is InternLM (书生·浦语).\n" \
...
#切换模板
build_template = build_template_internlm2
