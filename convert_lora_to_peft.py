...
from aigc_zoo.model_zoo.internlm2.llm_model import MyTransformer,PetlModel,PetlArguments,PromptArguments,InternLM2Config,InternLM2Tokenizer
...
def convert_to_peft(ckpt_dir,output_dir = './peft_lora'):
    ...
    tokenizer, _, _, _ = dataHelper.load_tokenizer_and_config(config_class_name=InternLM2Config,
