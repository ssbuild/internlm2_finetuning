...
from aigc_zoo.model_zoo.internlm2.llm_model import MyTransformer,PromptArguments,InternLM2Config,InternLM2Tokenizer
...
if __name__ == '__main__':
    ...
    config = InternLM2Config.from_pretrained(train_weight_dir)
